...
int Xonix()
{
    ...
    Texture t1,t2,t3,t4;
    t1.loadFromFile("xonix/tiles.png");
    t2.loadFromFile("xonix/gameover.png");
    t3.loadFromFile("xonix/enemy.png");
    t4.loadFromFile("xonix/returntomenu.png");

    Sprite sTile(t1), sGameover(t2), sEnemy(t3), Returntomenu(t4);
    sGameover.setPosition(100,100);
    Returntomenu.setPosition(150,280);
        ...
        while (window.pollEvent(e))
        {
            ...
            if (e.type == sf::Event::MouseButtonPressed) {
                if (e.mouseButton.button == sf::Mouse::Left) {
                    if (Returntomenu.getGlobalBounds().contains(e.mouseButton.x, e.mouseButton.y)) {
                        window.close();
                        GameBoy::MainMenu();
